...
Solution GraspSwapInterVNS::localSearch(Solution solution) {
...
std::pair<int,int> GraspSwapInterVNS::tct_inter(int tct_i, int tct_j, const std::vector<int>& tasks_i, const std::vector<int>& tasks_j, int k, int l, Problem& problem) {
  int new_tct_i = tct_i;
  int new_tct_j = tct_j;
